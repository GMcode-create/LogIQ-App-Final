...
const Compare = () => {
  ...
  useEffect(() => {
    console.log('Compare: Initializing algorithms');
    initializeAlgorithms();
  }, [initializeAlgorithms]);
  ...
  const currentStep1 = algo1State.steps[algo1State.currentStep] || { array: inputArrayNumbers, activeIndices: [], comparedIndices: [], swappedIndices: [], description: "Ready to start", comparisons: 0, swaps: 0 };
  const currentStep2 = algo2State.steps[algo2State.currentStep] || { array: inputArrayNumbers, activeIndices: [], comparedIndices: [], swappedIndices: [], description: "Ready to start", comparisons: 0, swaps: 0 };
  ...
  const AlgorithmSection = ({ 
    ...
    const maxValue = inputArrayNumbers.length > 0 ? Math.max(...inputArrayNumbers) : 100;
