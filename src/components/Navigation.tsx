...
import { User, LogOut, Home, Scale, Code, Play, Code2 } from "lucide-react";
            ...
            <div className="flex items-center space-x-3">
              ...
              {user ? (
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-full px-6 py-2 text-sm font-medium transition-smooth overflow-fix"
                >
